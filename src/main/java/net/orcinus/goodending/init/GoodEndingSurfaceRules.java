...
public class GoodEndingSurfaceRules {
    ...
    public static SurfaceRules.RuleSource makeRules() {
        SurfaceRules.RuleSource ifTrue = SurfaceRules.ifTrue(SurfaceRules.isBiome(GoodEndingBiomes.OAK_HAMMOCK_FOREST), SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseThreshold(1.75), COARSE_DIRT), SurfaceRules.ifTrue(surfaceNoiseThreshold(-0.75), PODZOL), COARSE_DIRT));
        SurfaceRules.RuleSource swamp = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.isBiome(GoodEndingBiomes.MARSHY_SWAMP), SurfaceRules.ifTrue(SurfaceRules.yBlockCheck(VerticalAnchor.absolute(62), 0), SurfaceRules.ifTrue(SurfaceRules.not(SurfaceRules.yBlockCheck(VerticalAnchor.absolute(63), 0)), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SWAMP, 0.0), WATER)))));
