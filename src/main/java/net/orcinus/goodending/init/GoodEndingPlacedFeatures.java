...
public class GoodEndingPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> ctx) {
        ...
        PlacementUtils.register(ctx, BIG_LILY_PADS_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.LARGE_LILY_PADS), VegetationPlacements.worldSurfaceSquaredWithCount(6));
        PlacementUtils.register(ctx, PATCH_FLOWERING_WATERLILY_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_FLOWERING_WATERLILY), VegetationPlacements.worldSurfaceSquaredWithCount(2));
