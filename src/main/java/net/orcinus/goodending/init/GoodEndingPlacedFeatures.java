...
public class GoodEndingPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> ctx) {
        ...
        PlacementUtils.register(ctx, PATCH_ALGAE_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_ALGAE), CountPlacement.of(80), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
        ...
        PlacementUtils.register(ctx, MARSH_SWAMP_TREE_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.MARSH_MUDDY_OAK_TREE), RarityFilter.onAverageOnceEvery(10), CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), BiomeFilter.biome());
