...
//        PlacementUtils.register(ctx, MARSH_SWAMP_TREE_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.MARSH_MUDDY_OAK_TREE), CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, EnvironmentScanPlacement.scanningFor(Direction.DOWN, BlockPredicate.matchesTag(BlockTags.DIRT), BlockPredicate.ONLY_IN_AIR_PREDICATE, 12), BiomeFilter.biome());
        ...
        PlacementUtils.register(ctx, SWAMP_FALLEN_LOG_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.SWAMP_FALLEN_LOG), CountPlacement.of(20), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(ctx, BIRCH_FALLEN_LOG_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.BIRCH_FALLEN_LOG), RarityFilter.onAverageOnceEvery(30), CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(ctx, OAK_FALLEN_LOG_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.OAK_FALLEN_LOG), RarityFilter.onAverageOnceEvery(30), CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(ctx, SPRUCE_FALLEN_LOG_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.SPRUCE_FALLEN_LOG), RarityFilter.onAverageOnceEvery(30), CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(ctx, ACACIA_FALLEN_LOG_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.ACACIA_FALLEN_LOG), RarityFilter.onAverageOnceEvery(30), CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
        PlacementUtils.register(ctx, SWAMP_VEGETATION_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.SWAMP_VEGETATION), PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
        ...
        PlacementUtils.register(ctx, PATCH_PASTEL_WILDFLOWERS_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_PASTEL_WILDFLOWERS), CountPlacement.of(16), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
        PlacementUtils.register(ctx, PATCH_TWILIGHT_WILDFLOWERS_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_TWILIGHT_WILDFLOWERS), VegetationPlacements.worldSurfaceSquaredWithCount(2));
        PlacementUtils.register(ctx, PATCH_SPICY_WILDFLOWERS_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_SPICY_WILDFLOWERS), VegetationPlacements.worldSurfaceSquaredWithCount(3));
        PlacementUtils.register(ctx, PATCH_BALMY_WILDFLOWERS_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_BALMY_WILDFLOWERS), VegetationPlacements.worldSurfaceSquaredWithCount(1));
        PlacementUtils.register(ctx, TALL_BIRCH_TREE_FILTERED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.TALL_BIRCH_TREE), VegetationPlacements.worldSurfaceSquaredWithCount(1));
        PlacementUtils.register(ctx, TALL_BIRCH_VEGETATION_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.TALL_BIRCH_VEGETATION), VegetationPlacements.worldSurfaceSquaredWithCount(1));
        ...
        PlacementUtils.register(ctx, PATCH_PINK_FLOWERED_LILY_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_PINK_FLOWERED_LILY), VegetationPlacements.worldSurfaceSquaredWithCount(4));
        PlacementUtils.register(ctx, PATCH_TALL_GRASS_PLACED, holderGetter.getOrThrow(VegetationFeatures.PATCH_TALL_GRASS), CountPlacement.of(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, RandomOffsetPlacement.vertical(ConstantInt.of(-1)), BlockPredicateFilter.forPredicate(BlockPredicate.matchesBlocks(Blocks.COARSE_DIRT)), BiomeFilter.biome());
        PlacementUtils.register(ctx, PATCH_FERN_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_FERN), CountPlacement.of(8), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0), PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BiomeFilter.biome());
        PlacementUtils.register(ctx, PATCH_LARGE_FERN_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_LARGE_FERN), boulderModifier(19, PlacementUtils.HEIGHTMAP_WORLD_SURFACE));
        PlacementUtils.register(ctx, OAK_HAMMOCK_PATCH_TALL_GRASS_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.OAK_HAMMOCK_PATCH_TALL_GRASS), boulderModifier(25, PlacementUtils.HEIGHTMAP_WORLD_SURFACE));
        PlacementUtils.register(ctx, BIG_LILY_PADS_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.LARGE_LILY_PADS), boulderModifier(20, PlacementUtils.HEIGHTMAP_WORLD_SURFACE));
        PlacementUtils.register(ctx, PATCH_FLOWERING_WATERLILY_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.PATCH_FLOWERING_WATERLILY), boulderModifier(25, PlacementUtils.HEIGHTMAP_WORLD_SURFACE));
        PlacementUtils.register(ctx, DISK_PODZOL_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.DISK_PODZOL), boulderModifier(19, PlacementUtils.HEIGHTMAP_TOP_SOLID));
//        PlacementUtils.register(ctx, OAK_HAMMOCK_TREES_PLACED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.OAK_HAMMOCK_TREES), boulderModifier(19, PlacementUtils.HEIGHTMAP_TOP_SOLID));
