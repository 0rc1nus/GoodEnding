...
public class GoodEndingPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> ctx) {
        ...
        PlacementUtils.register(ctx, CYPRESS_TREE_CHECKED, holderGetter.getOrThrow(GoodEndingConfiguredFeatures.CYPRESS_TREE), PlacementUtils.filteredByBlockSurvival(GoodEndingBlocks.CYPRESS_SAPLING.get()));
