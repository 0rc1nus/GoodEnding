...
public class GoodEndingBlocks {
    ...
    //Muddy oak wood set
    public static final Block MUDDY_OAK_PLANKS = register("muddy_oak_planks", new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(2.0f, 3.0f).sound(SoundType.WOOD)));
    public static final Block MUDDY_OAK_LOG = register("muddy_oak_log", new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(state -> state.getValue(RotatedPillarBlock.AXIS) == Direction.Axis.Y ? MapColor.COLOR_LIGHT_GREEN : MapColor.COLOR_GRAY).strength(2.0F).sound(SoundType.WOOD)));
    public static final Block STRIPPED_MUDDY_OAK_LOG = register("stripped_muddy_oak_log", new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(2.0F).sound(SoundType.WOOD)));
    public static final Block STRIPPED_MUDDY_OAK_WOOD = register("stripped_muddy_oak_wood", new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).strength(2.0f).sound(SoundType.WOOD)));
    public static final Block MUDDY_OAK_WOOD = register("muddy_oak_wood", new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).strength(2.0f).sound(SoundType.WOOD)));
    public static final Block MUDDY_OAK_SLAB = register("muddy_oak_slab", new SlabBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).strength(2.0f, 3.0f).sound(SoundType.WOOD)));
    public static final Block MUDDY_OAK_FENCE = register("muddy_oak_fence", new FenceBlock(BlockBehaviour.Properties.of().mapColor(MUDDY_OAK_PLANKS.defaultMapColor()).strength(3.0f).sound(SoundType.WOOD).noOcclusion()));
    ...
    public static final Block CYPRESS_LOG = register("cypress_log", new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(state -> state.getValue(RotatedPillarBlock.AXIS) == Direction.Axis.Y ? MapColor.COLOR_BROWN : MapColor.COLOR_LIGHT_GRAY).strength(2.0F).sound(SoundType.WOOD)));
    ...
    public static final Block STRIPPED_CYPRESS_LOG = register("stripped_cypress_log", new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).strength(2.0F).sound(SoundType.WOOD)));
    public static final Block STRIPPED_CYPRESS_WOOD = register("stripped_cypress_wood", new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).strength(2.0f).sound(SoundType.WOOD)));
    public static final Block CYPRESS_WOOD = register("cypress_wood", new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).strength(2.0f).sound(SoundType.WOOD)));
    ...
    public static final Block CYPRESS_SLAB = register("cypress_slab", new SlabBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).strength(2.0f, 3.0f).sound(SoundType.WOOD)));
    public static final Block CYPRESS_FENCE = register("cypress_fence", new FenceBlock(BlockBehaviour.Properties.of().mapColor(CYPRESS_PLANKS.defaultMapColor()).strength(3.0f).sound(SoundType.WOOD).noOcclusion()));
    ...
    public static final Block CYPRESS_PRESSURE_PLATE = register("cypress_pressure_plate", new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of().mapColor(CYPRESS_PLANKS.defaultMapColor()).noCollission().strength(0.5f).sound(SoundType.WOOD), GoodEndingBlockSetTypes.CYPRESS));
