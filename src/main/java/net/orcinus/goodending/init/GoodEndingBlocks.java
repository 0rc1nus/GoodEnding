...
public class GoodEndingBlocks {
    ...
    public static final Block HANGING_OAK_LEAVES = register("hanging_oak_leaves", new HangingLeavesBlock(AbstractBlock.Settings.copy(Blocks.OAK_LEAVES).noCollision().breakInstantly().sounds(GoodEndingBlockSoundGroups.HANGING_LEAVES), HANGING_OAK_LEAVES_PLANT));
    ...
    public static final Block HANGING_DARK_OAK_LEAVES = register("hanging_dark_oak_leaves", new HangingLeavesBlock(AbstractBlock.Settings.copy(Blocks.OAK_LEAVES).noCollision().breakInstantly().sounds(GoodEndingBlockSoundGroups.HANGING_LEAVES), HANGING_DARK_OAK_LEAVES_PLANT));
