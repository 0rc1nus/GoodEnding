...
public class GoodEndingEntityTypes {
    ...
    public static final RegistryObject<EntityType<GoodEndingChestBoatEntity>> CHEST_BOAT = ENTITY_TYPES.register("chest_boat", () -> EntityType.Builder.<GoodEndingChestBoatEntity>of(GoodEndingChestBoatEntity::new, MobCategory.MISC).sized(1.375f, 0.5625f).clientTrackingRange(10).build(new ResourceLocation(GoodEnding.MODID, "chest_boat").toString()));    public static final RegistryObject<EntityType<FireflyEntity>> FIREFLY_SWARM = ENTITY_TYPES.register("firefly_swarm", () -> EntityType.Builder.of(FireflyEntity::new, MobCategory.CREATURE).sized(1F, 1F).clientTrackingRange(8).build(new ResourceLocation(GoodEnding.MODID, "firefly_swarm").toString()));
