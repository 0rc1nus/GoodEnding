...
public class GoodEndingWorldGen {
    ...
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> MUDDY_OAK_TREE = register("swamp_tree", GoodEndingFeatures.MUDDY_OAK_TREE_FEATURE, new TreeFeatureConfig.Builder(BlockStateProvider.of(GoodEndingBlocks.MUDDY_OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.of(Blocks.OAK_LEAVES), new DarkOakFoliagePlacer(ConstantIntProvider.create(0), ConstantIntProvider.create(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty())).build());
    ...
    public static final RegistryEntry<ConfiguredFeature<TreeFeatureConfig, ?>> MARSH_MUDDY_OAK_TREE = register("marsh_swamp_tree", GoodEndingFeatures.MARSH_MUDDY_OAK_TREE_FEATURE, new TreeFeatureConfig.Builder(BlockStateProvider.of(GoodEndingBlocks.MUDDY_OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.of(Blocks.OAK_LEAVES), new DarkOakFoliagePlacer(ConstantIntProvider.create(0), ConstantIntProvider.create(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty())).build());
    ...
    public static final RegistryEntry<ConfiguredFeature<FallenLogConfig, ?>> BIRCH_FALLEN_LOG = register("birch_fallen_log", GoodEndingFeatures.FALLEN_LOG, new FallenLogConfig(BlockStateProvider.of(Blocks.BIRCH_LOG), UniformIntProvider.create(6, 8), true, true));
    ...
    public static final RegistryEntry<ConfiguredFeature<FallenLogConfig, ?>> OAK_FALLEN_LOG = register("oak_fallen_log", GoodEndingFeatures.FALLEN_LOG, new FallenLogConfig(BlockStateProvider.of(Blocks.OAK_LOG), UniformIntProvider.create(6, 8), false, true));
    public static final RegistryEntry<PlacedFeature> OAK_FALLEN_LOG_PLACED = register("oak_fallen_log", OAK_FALLEN_LOG, CountPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, EnvironmentScanPlacementModifier.of(Direction.DOWN, BlockPredicate.matchingBlockTag(BlockTags.DIRT), BlockPredicate.matchingBlocks(Blocks.AIR, Blocks.GRASS, Blocks.TALL_GRASS), 12), BiomePlacementModifier.of());

    public static final RegistryEntry<ConfiguredFeature<FallenLogConfig, ?>> SPRUCE_FALLEN_LOG = register("spruce_fallen_log", GoodEndingFeatures.FALLEN_LOG, new FallenLogConfig(BlockStateProvider.of(Blocks.SPRUCE_LOG), UniformIntProvider.create(6, 8), false, false));
    public static final RegistryEntry<PlacedFeature> SPRUCE_FALLEN_LOG_PLACED = register("spruce_fallen_log", SPRUCE_FALLEN_LOG, CountPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, EnvironmentScanPlacementModifier.of(Direction.DOWN, BlockPredicate.matchingBlockTag(BlockTags.DIRT), BlockPredicate.matchingBlocks(Blocks.AIR, Blocks.GRASS, Blocks.TALL_GRASS), 12), BiomePlacementModifier.of());

    public static final RegistryEntry<ConfiguredFeature<FallenLogConfig, ?>> ACACIA_FALLEN_LOG = register("acacia_fallen_log", GoodEndingFeatures.FALLEN_LOG, new FallenLogConfig(BlockStateProvider.of(Blocks.ACACIA_LOG), UniformIntProvider.create(4, 6), false, false));
    public static final RegistryEntry<PlacedFeature> ACACIA_FALLEN_LOG_PLACED = register("acacia_fallen_log", ACACIA_FALLEN_LOG, CountPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, EnvironmentScanPlacementModifier.of(Direction.DOWN, BlockPredicate.matchingBlockTag(BlockTags.DIRT), BlockPredicate.matchingBlocks(Blocks.AIR, Blocks.GRASS, Blocks.TALL_GRASS), 12), BiomePlacementModifier.of());
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomPatchFeatureConfig, ?>> PATCH_LARGE_FERN = register("patch_large_fern", Feature.RANDOM_PATCH, ConfiguredFeatures.createRandomPatchFeatureConfig(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.LARGE_FERN)), List.of(), 32));
    public static final RegistryEntry<ConfiguredFeature<RandomPatchFeatureConfig, ?>> OAK_HAMMOCK_PATCH_TALL_GRASS = register("oak_hammock_patch_tall_grass", Feature.RANDOM_PATCH, ConfiguredFeatures.createRandomPatchFeatureConfig(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.TALL_GRASS)), List.of(), 30));
    ...
    public static final RegistryEntry<PlacedFeature> PATCH_FERN_PLACED = register("patch_fern_placed", PATCH_FERN, VegetationPlacedFeatures.modifiers(3));
