...
public class GoodEndingConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> ctx) {
        ...
        FeatureUtils.register(ctx, SHALLOW_WATER_MUD, GoodEndingFeatures.SHALLOW_WATER.get(), new ShallowWaterConfig(BlockStateProvider.simple(Blocks.MUD), true, false, 6, 0.25F));
        FeatureUtils.register(ctx, PATCH_ALGAE, GoodEndingFeatures.ALGAE_PATCH.get(), new NoneFeatureConfiguration());
        FeatureUtils.register(ctx, CYPRESS_TREE, GoodEndingFeatures.CYPRESS_TREE.get(), new WaterTreeFeatureConfig.WaterTreeFeatureBuilder(BlockStateProvider.simple(Blocks.OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.OAK_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty()), false).gebuild());
        FeatureUtils.register(ctx, CYPRESS_TREE_PLANTED, GoodEndingFeatures.CYPRESS_TREE.get(), new WaterTreeFeatureConfig.WaterTreeFeatureBuilder(BlockStateProvider.simple(Blocks.OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.OAK_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty()), true).gebuild());
        ...
        FeatureUtils.register(ctx, MUDDY_OAK_TREE, GoodEndingFeatures.MUDDY_OAK_TREE_FEATURE.get(), new MuddyOakFeatureConfig.MuddyOakFeatureBuilder(BlockStateProvider.simple(GoodEndingBlocks.MUDDY_OAK_LOG.get()), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.OAK_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty()), true).gebuild());
        FeatureUtils.register(ctx, MARSH_MUDDY_OAK_TREE, GoodEndingFeatures.MUDDY_OAK_TREE_FEATURE.get(), new MuddyOakFeatureConfig.MuddyOakFeatureBuilder(BlockStateProvider.simple(GoodEndingBlocks.MUDDY_OAK_LOG.get()), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.OAK_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty()), false).gebuild());
        FeatureUtils.register(ctx, CATTAIL_PATCH, GoodEndingFeatures.HALF_WATERLOGGED_DECORATION.get(), new HalfWaterloggedDecorationConfig(BlockStateProvider.simple(GoodEndingBlocks.CATTAIL.get()), UniformInt.of(6, 8)));
        FeatureUtils.register(ctx, SWAMP_FALLEN_LOG, GoodEndingFeatures.FALLEN_LOG.get(), new FallenLogConfig(BlockStateProvider.simple(GoodEndingBlocks.MUDDY_OAK_LOG.get()), UniformInt.of(4, 6), false, true));
        FeatureUtils.register(ctx, BIRCH_FALLEN_LOG, GoodEndingFeatures.FALLEN_LOG.get(), new FallenLogConfig(BlockStateProvider.simple(Blocks.BIRCH_LOG), UniformInt.of(6, 8), true, true, false));
        FeatureUtils.register(ctx, OAK_FALLEN_LOG, GoodEndingFeatures.FALLEN_LOG.get(), new FallenLogConfig(BlockStateProvider.simple(Blocks.OAK_LOG), UniformInt.of(6, 8), false, true, false));
        FeatureUtils.register(ctx, SPRUCE_FALLEN_LOG, GoodEndingFeatures.FALLEN_LOG.get(), new FallenLogConfig(BlockStateProvider.simple(Blocks.SPRUCE_LOG), UniformInt.of(6, 8), false, false, false));
        FeatureUtils.register(ctx, ACACIA_FALLEN_LOG, GoodEndingFeatures.FALLEN_LOG.get(), new FallenLogConfig(BlockStateProvider.simple(Blocks.ACACIA_LOG), UniformInt.of(4, 6), false, false, false));
        ...
        FeatureUtils.register(ctx, DUCKWEED_PATCH, GoodEndingFeatures.DUCKWEED_PATCH.get(), new NoneFeatureConfiguration());
        FeatureUtils.register(ctx, PATCH_PASTEL_WILDFLOWERS, Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(GoodEndingBlocks.PASTEL_WILDFLOWERS.get())), List.of(Blocks.GRASS_BLOCK)));
        FeatureUtils.register(ctx, PATCH_TWILIGHT_WILDFLOWERS, Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(GoodEndingBlocks.TWILIGHT_WILDFLOWERS.get())), List.of(Blocks.GRASS_BLOCK, Blocks.MUD, Blocks.COARSE_DIRT, Blocks.PODZOL)));
        FeatureUtils.register(ctx, PATCH_SPICY_WILDFLOWERS, Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(GoodEndingBlocks.SPICY_WILDFLOWERS.get())), List.of(Blocks.GRASS_BLOCK, Blocks.COARSE_DIRT, Blocks.PODZOL)));
        FeatureUtils.register(ctx, PATCH_BALMY_WILDFLOWERS, Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(GoodEndingBlocks.BALMY_WILDFLOWERS.get())), List.of(Blocks.GRASS_BLOCK)));
        ...
        FeatureUtils.register(ctx, PATCH_TALL_GRASS_MARSH, Feature.RANDOM_PATCH, FeatureUtils.simpleRandomPatchConfiguration(32, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.TALL_GRASS)))));
        FeatureUtils.register(ctx, TALL_BIRCH_TREE, GoodEndingFeatures.TALL_BIRCH_TREE.get(), new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.BIRCH_LOG), new StraightTrunkPlacer(5, 2, 1), BlockStateProvider.simple(Blocks.BIRCH_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new TwoLayersFeatureSize(0,0,0)).build());
        ...
        FeatureUtils.register(ctx, PATCH_PINK_FLOWERED_LILY, Feature.RANDOM_PATCH, new RandomPatchConfiguration(6, 2, 3, PlacementUtils.inlinePlaced(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(GoodEndingBlocks.PINK_FLOWERING_LILY_PAD.get())))));
        ...
        FeatureUtils.register(ctx, LARGE_LILY_PADS, GoodEndingFeatures.LARGE_LILY_PADS.get(), new NoneFeatureConfiguration());
        ...
        FeatureUtils.register(ctx, FANCY_DARK_OAK, GoodEndingFeatures.FANCY_DARK_OAK.get(), new FancyDarkOakTreeConfig.FancyDarkOakTreeConfigBuilder(false, false).gebuild());
        FeatureUtils.register(ctx, FANCY_DARK_OAK_PLANTED, GoodEndingFeatures.FANCY_DARK_OAK.get(), new FancyDarkOakTreeConfig.FancyDarkOakTreeConfigBuilder(false, true).gebuild());
        FeatureUtils.register(ctx, BIG_FANCY_DARK_OAK, GoodEndingFeatures.FANCY_DARK_OAK.get(), new FancyDarkOakTreeConfig.FancyDarkOakTreeConfigBuilder(true, false).gebuild());
        FeatureUtils.register(ctx, BIG_FANCY_DARK_OAK_PLANTED, GoodEndingFeatures.FANCY_DARK_OAK.get(), new FancyDarkOakTreeConfig.FancyDarkOakTreeConfigBuilder(true, true).gebuild());
        ...
        FeatureUtils.register(ctx, GRANITE_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(true, BlockStateProvider.simple(Blocks.LIGHT_GRAY_TERRACOTTA), BlockStateProvider.simple(Blocks.GRANITE), UniformFloat.of(2, 4.2F)));
        FeatureUtils.register(ctx, PLAINS_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(true, BlockStateProvider.simple(Blocks.STONE), BlockStateProvider.simple(Blocks.TUFF), UniformFloat.of(2, 3.5F)));
        FeatureUtils.register(ctx, DESERT_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(true, BlockStateProvider.simple(Blocks.SANDSTONE), BlockStateProvider.simple(Blocks.SANDSTONE), UniformFloat.of(2, 3.5F)));
        FeatureUtils.register(ctx, RED_SANDSTONE_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(true, BlockStateProvider.simple(Blocks.RED_SANDSTONE), BlockStateProvider.simple(Blocks.RED_SANDSTONE), UniformFloat.of(2, 3.5F)));
        FeatureUtils.register(ctx, SMOOTH_BASALT_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(true, BlockStateProvider.simple(Blocks.SMOOTH_BASALT), BlockStateProvider.simple(Blocks.SMOOTH_BASALT), UniformFloat.of(2.3F, 5.4F)));
        FeatureUtils.register(ctx, STONE_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(true, BlockStateProvider.simple(Blocks.STONE), BlockStateProvider.simple(Blocks.STONE), UniformFloat.of(2.1F, 4.8F)));
        FeatureUtils.register(ctx, TUFF_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(true, BlockStateProvider.simple(Blocks.TUFF), BlockStateProvider.simple(Blocks.TUFF), UniformFloat.of(2.2F, 5.2F)));
        FeatureUtils.register(ctx, COBBLESTONE_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(true, BlockStateProvider.simple(Blocks.COBBLESTONE), BlockStateProvider.simple(Blocks.COBBLESTONE), UniformFloat.of(2F, 3F)));
        FeatureUtils.register(ctx, MOSSY_COBBLESTONE_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(true, BlockStateProvider.simple(Blocks.MOSSY_COBBLESTONE), BlockStateProvider.simple(Blocks.COBBLESTONE), UniformFloat.of(2F, 3F)));
        FeatureUtils.register(ctx, MOSSIER_COBBLESTONE_BOULDER, GoodEndingFeatures.BOULDER.get(), new BoulderConfig(false, BlockStateProvider.simple(Blocks.MOSS_BLOCK), BlockStateProvider.simple(Blocks.MOSSY_COBBLESTONE), UniformFloat.of(2, 4.2F)));
    }
