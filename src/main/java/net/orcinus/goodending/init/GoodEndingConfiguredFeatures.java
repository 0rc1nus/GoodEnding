...
public class GoodEndingConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> ctx) {
        ...
        FeatureUtils.register(ctx, FANCY_DARK_OAK, GoodEndingFeatures.FANCY_DARK_OAK, new FancyDarkOakTreeConfig.FancyDarkOakTreeConfigBuilder(false, false).gebuild());
        FeatureUtils.register(ctx, FANCY_DARK_OAK_PLANTED, GoodEndingFeatures.FANCY_DARK_OAK, new FancyDarkOakTreeConfig.FancyDarkOakTreeConfigBuilder(false, true).gebuild());
        FeatureUtils.register(ctx, BIG_FANCY_DARK_OAK, GoodEndingFeatures.FANCY_DARK_OAK, new FancyDarkOakTreeConfig.FancyDarkOakTreeConfigBuilder(true, false).gebuild());
        FeatureUtils.register(ctx, BIG_FANCY_DARK_OAK_PLANTED, GoodEndingFeatures.FANCY_DARK_OAK, new FancyDarkOakTreeConfig.FancyDarkOakTreeConfigBuilder(true, true).gebuild());
