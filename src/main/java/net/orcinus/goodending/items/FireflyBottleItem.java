...
public class FireflyBottleItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (world instanceof ServerLevel serverWorld) {
            ...
            FireflyEntity fireflyEntity = GoodEndingEntityTypes.FIREFLY_SWARM.get().create(world);
            ...
            world.playSound(null, blockPos, GoodEndingSoundEvents.ITEM_FIREFLY_BOTTLE_EMPTY.get(), SoundSource.NEUTRAL, 2.0F, 1.0F);
