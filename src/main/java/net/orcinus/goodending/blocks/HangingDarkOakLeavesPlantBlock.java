...
public class HangingDarkOakLeavesPlantBlock extends AbstractPlantBlock {
    public static final VoxelShape SHAPE = Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 16.0, 15.0);

    public HangingDarkOakLeavesPlantBlock(AbstractBlock.Settings settings) {
    ...
    protected AbstractPlantStemBlock getStem() {
        return (AbstractPlantStemBlock) GoodEndingBlocks.HANGING_DARK_OAK_LEAVES;
    }
}
