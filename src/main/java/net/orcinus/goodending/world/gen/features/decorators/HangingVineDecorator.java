...
public class HangingVineDecorator extends TreeDecorator {
    public static final Codec<HangingVineDecorator> CODEC = RecordCodecBuilder.create(instance -> instance.group(Codec.BOOL.fieldOf("darkOak").forGetter(config -> config.darkOak)).apply(instance, HangingVineDecorator::new));

    private final boolean darkOak;

    public HangingVineDecorator(boolean darkOak) {
        this.darkOak = darkOak;
    }

    @Override
    protected TreeDecoratorType<?> getType() {
        return GoodEndingTreeDecorators.HANGING_VINE_DECORATOR;
    }
