                    ...
                    for (int i = 0; i <= height; i++) {
                        ...
                        if (i == height) {
                            if (world.isStateAtPosition(placePos, BlockBehaviour.BlockStateBase::isAir)) {
                                generator.setBlock(placePos, this.darkOak ? GoodEndingBlocks.HANGING_DARK_OAK_LEAVES.defaultBlockState().setValue(HangingLeavesBlock.AGE, Mth.nextInt(random, 22, 25)) : GoodEndingBlocks.HANGING_OAK_LEAVES.defaultBlockState().setValue(HangingLeavesBlock.AGE, Mth.nextInt(random, 22, 25)));
                                break;
                            }
                        }
                        if (world.isStateAtPosition(placePos, BlockBehaviour.BlockStateBase::isAir)) {
                            generator.setBlock(placePos, this.darkOak ? GoodEndingBlocks.HANGING_DARK_OAK_LEAVES_PLANT.defaultBlockState() : GoodEndingBlocks.HANGING_OAK_LEAVES_PLANT.defaultBlockState());
                        }
                    }
                }
            }
