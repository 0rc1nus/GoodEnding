                ...
                for (int i = 0; i <= length; i++) {
                    if (world.isEmptyBlock(mutable)) {
                        if (i == length || !world.isEmptyBlock(mutable.below())) {
                            world.setBlock(mutable, GoodEndingBlocks.HANGING_OAK_LEAVES.defaultBlockState().setValue(GrowingPlantHeadBlock.AGE, Mth.nextInt(random, 17, 25)), 2);
                            break;
                        }
                        world.setBlock(mutable, GoodEndingBlocks.HANGING_OAK_LEAVES_PLANT.defaultBlockState(), 2);
                    }
