...
public class VanillaSurfaceRulesMixin {
    ...
    private static MaterialRules.MaterialRule injected(MaterialRules.MaterialRule materialRule) {
        ...
        return MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(BiomeKeys.SWAMP), MaterialRules.sequence(MaterialRules.condition(surfaceNoiseThreshold(1.75), GRASS_BLOCK), MaterialRules.condition(surfaceNoiseThreshold(-0.75), MUD), GRASS_BLOCK)))), MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, swamp), MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, condition), materialRule);
    }
